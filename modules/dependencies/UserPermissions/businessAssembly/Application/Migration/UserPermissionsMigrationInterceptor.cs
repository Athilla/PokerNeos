...
namespace GroupeIsa.Neos.TenantManagement.Tenants.Application.Migration
{
    ...
    /// </summary>
    internal class UserPermissionsMigrationInterceptor : ITenantDatabaseMigrationInterceptor
    {
        ...
        public UserPermissionsMigrationInterceptor(ISaveUsersToAuthenticationServer saveUsersToAuthenticationServer,
